...
namespace Anagram
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //new AnagramUtilities("a b c d", "a74caae2896653023ae0013f88249f91", "wordlist_original.txt");                // d c b a
            //new AnagramUtilities("a b c d a b c d", "430530dae271684171f86612d00935ad", "wordlist_original.txt");        // d c b a d c b a

            //new AnagramUtilities("trustpilot outwits ants turnout", "ff771224323d73673f24b50192ae2e5c", "wordlist_original.txt");                // trustpilot outwits ants a c d turnout
